...
`0.5.1` release lives at `vendor/asig-0.5.1/` and contains the generated design tokens,
...
existing consumers; building `0.5.1` creates a new directory and must not rewrite an older
snapshot.
