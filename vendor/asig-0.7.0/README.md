...
| [Component contracts](docs/COMPONENT_CONTRACTS.md) | Inputs, outputs, events, state ownership and framework integration |
...
Install the stable 0.7 release:
...
screen-reader and platform checks remain explicit in the [release evidence](docs/releases/0.7.0-accessibility-evidence.md).
