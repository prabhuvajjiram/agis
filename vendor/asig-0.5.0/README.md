...
Version `0.5.0` is the current release. It adds professional action hierarchy, a
progressive-disclosure contract for dense workspaces, and public MIT-licensed npm packages,
while retaining the navigation, choices, data-display, feedback, confirmation, selection,
and WCAG 2.1 AA foundations from `0.4.0`.
