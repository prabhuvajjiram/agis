...
Version `0.4.0` modernizes navigation, choices, data display, feedback, and confirmation
patterns; corrects the searchable picker focus model; improves intermediate-width reflow;
and expands accessibility and cross-platform visual regression evidence. Registry
